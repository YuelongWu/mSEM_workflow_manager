function scanned_cell  = utils_textscan_trackroi(input_str, fmt_str, Delimit)
    ...
    try
        ...
        % initialize output: str->''; float->nan; int->0
        ...
        for t = 1:tN
            try
                outcellt = textscan(input_str{t}, fmt_str, 'Delimiter', Delimit, ...
                        'ReturnOnError', 0);
                for k = 1:length(scanned_cell)
